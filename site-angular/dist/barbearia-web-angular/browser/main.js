...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-CSFGT4D2.js").then((m) => m);
...
// src/app/guards/dashboard-perfil.guard.ts
...
var routes = [
  ...
  { path: "login", loadComponent: () => import("./chunk-OKV7VHLW.js").then((m) => m.LoginComponent) },
  { path: "cadastro", loadComponent: () => import("./chunk-5D6JH34N.js").then((m) => m.CadastroComponent) },
  { path: "esqueci-senha", loadComponent: () => import("./chunk-GI5RKEUF.js").then((m) => m.EsqueciSenhaComponent) },
  { path: "reset-senha", loadComponent: () => import("./chunk-C44JQEU3.js").then((m) => m.ResetSenhaComponent) },
  { path: "dashboard", loadComponent: () => import("./chunk-UIHAYMPY.js").then((m) => m.DashboardWrapperComponent), canActivate: [authGuard, webPerfilGuard, dashboardDonoGuard] },
  { path: "dashboard-recepcao", loadComponent: () => import("./chunk-RRMNQW2H.js").then((m) => m.DashboardRecepcaoComponent), canActivate: [authGuard, webPerfilGuard, dashboardRecepcaoGuard] },
  { path: "perfil", loadComponent: () => import("./chunk-3YAUHC2S.js").then((m) => m.PerfilComponent), canActivate: [authGuard, webPerfilGuard] },
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275ProvidersFeature([MessageService]), \u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
