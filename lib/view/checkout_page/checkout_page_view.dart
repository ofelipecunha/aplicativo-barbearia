...
import 'package:barbearia/view/checkout_page/widgets/address.dart';
import 'package:barbearia/view/checkout_page/widgets/payment.dart';
...
import 'package:barbearia/view/success_page/success_page_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Checkout", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold ),),
        elevation: 0,
      ),
            ...
            return Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: SizeConfig.screenWidth!/34.25,),                
                  if(currentStep != 0)
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Back", style: TextStyle(color: Colors.white, fontSize: SizeConfig.screenHeight!/37.95, fontWeight: FontWeight.bold),),),   
                        ),
                      ),
                    ),
                ],
