                          ...
                          children: [
                            ...
                            Positioned(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(food.foodName, style: TextStyle(fontSize: SizeConfig.screenHeight!/34.15, color: Colors.white)),       
                                    Text(food.foodCategory, style: TextStyle(fontSize: SizeConfig.screenHeight!/48.79, color: Colors.white)),   
                                    Text("\$${food.foodPrice}", style: TextStyle(fontSize: SizeConfig.screenHeight!/37.95, color: Colors.white))     
                                  ],
                                )
                            ),
                            Positioned(
