          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text("4.6", style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontSize: SizeConfig.screenHeight!/45.54),),  
                Padding(
            ...
            Row(
              children: [
                ...
                Text("FREE DELIVERY", style: TextStyle(color: freeDelivery, fontWeight: FontWeight.bold, fontSize: SizeConfig.screenHeight!/42.69),)  
              ],
            )
          ],
        )
